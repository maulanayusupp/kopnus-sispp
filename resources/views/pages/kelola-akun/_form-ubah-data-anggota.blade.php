...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group{{ $errors->has('user_id') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-1">
                <div class="fg-line">
                    {!! Form::text('user_id', $dataAnggota->user_id, ['class'=>'form-control input-sm','readonly']) !!}
                </div>
...
<div class="row">
    <div class="col-sm-12">
        <div class="form-group{{ $errors->has('nama') ? ' has-error' : '' }}">
            ...
            <div class="col-sm-4">
                <div class="fg-line">
                    {!! Form::text('nama', $dataAnggota->user->name, ['class'=>'form-control input-sm','placeholder'=>'Nama Lengkap', 'readonly']) !!}
                </div>
                @if($errors->has('nama'))
                    <span class="help-block">
