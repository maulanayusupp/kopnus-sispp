...
@section('content')
<div class="card">
    {!! Form::model($pembayaran, ['route' => ['kelola.pembayaran.verifikasi', $pembayaran],'method' =>'patch','role'=>'form','class'=>'form-horizontal'])!!}
        {!! csrf_field() !!}
        <div class="card-body card-padding">            
			<div class="row">
			    <div class="col-sm-12">
			        <div class="form-group">
			            ...
			            <div class="col-sm-2">
			                <div class="fg-line">
			                    {!! Form::select('status', array('Sudah Dibayar' => 'Sudah Dibayar','Belum Dibayar' => 'Belum Dibayar'), null, ['class'=>'chosen']) !!}
			                </div>
			            </div>
			        </div>                    
			    </div>
			...
			<div class="form-group">
			    <center>
			        <button type="submit" class="btn btn-primary">{{ isset($pembayaran) ? 'Verifikasi ' : 'Verifikasi'}}</button>
			    </center>
			</div>
        </div>
    {!! Form::close() !!}
